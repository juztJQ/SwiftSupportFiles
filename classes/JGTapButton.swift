...
public class JGTapButton: UIButton {
    ...
    @IBInspectable public var fontColor: UIColor = UIColor.clear
   ...
   // private var tapGlowBackgroundColor = UIColor(white: 0.05, alpha: 1)
    
    private var tapGlowColor = UIColor.clear
    private var tapGlowBackgroundColor = UIColor.clear
    ...
    private func drawTapButton(_ buttonShape: TapButtonShape, buttonTitle: String, fontsize: CGFloat) -> UIBezierPath {
        ...
        let shadow = UIColor.clear.cgColor
